package com.example.ticketing.common.handler;

import com.example.ticketing.common.exception.CustomException;
import com.example.ticketing.common.response.APIErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIErrorResponse> handleEmotionBotException(final CustomException exception) {
